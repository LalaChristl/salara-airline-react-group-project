  ...
  return (
    <div>
      {filteredArr.map((item, i) => (
        <div key={i} className="text-[14px] flex  mb-[1rem]">
          <div
            className={` flex items-center w-[498.41px] ${
              state?.itinerary ? "h-[120px]" : "h-[105px] hover:shadow-2xl"
          ...
          >
            ...
            <div className="w-[97.48px] pr-[5px] text-center ">
              ...
              <p className="text-[#232B38] font-[700]">{item.travelDuration}</p>
            </div>
            <div
              onClick={() => dispatch({ type: "itinerary" })}
